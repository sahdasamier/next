...
export const ProjectCard = ({ data }: ProjectCardProps) => {
	...
	return (
		<div className='rounded-lg shadow-lg bg-grey-light w-full sm:w-1/3-g'>
			...
			/>
			<div className='p-4'>
				<h3 className='text-lg font-medium text-purple '>{title}</h3>
				<p className='text-sm mt-2 min-h-50 text-purple'>{body1}</p>
				<p className='text-sm mt-2 min-h-50 text-purple'>{body2}</p>
